...
import { useRef, useEffect, useMemo, type CSSProperties, type JSX } from 'react'
...
export default function Rays({
  ...
  const [randomColor1RGB, randomColor2RGB] = useMemo(() => {
    if (raysColor.mode === 'random') {
      // eslint-disable-next-line react-hooks/purity -- intentional random palette for this mode
